...
const services = [
  {
    ...
    description: "Professional bidders with years of experience ensuring your success in every auction.",
  },
  {
    icon: "fas fa-chart-bar",
    title: "Market Analysis",
    description: "Deep market insights and real-time analysis to maximize your bidding strategy.",
  },
  {
    icon: "fas fa-shield-alt",
    title: "Secure Process",
    description: "100% secure and confidential bidding process with complete transparency.",
  },
]
    ...
    <section id="services" className="py-24 bg-white/50 backdrop-blur-md">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600">Comprehensive auction solutions tailored for your success</p>
        </div>
